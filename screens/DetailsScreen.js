    ...
    >
        ...
        <View className="flex-row justify-center">
            <CachedImage
              ...
              style={{width:wp(98),height:hp(58),borderRadius:53,borderBottomLeftRadius:40,borderBottomRightRadius:40,marginTop:4}}
              />
        </View>
     ...
     {loading?(
        <Loading size="large" className="mt-16"></Loading>
     ):(
        ...
        <Animated.View entering={FadeInDown.duration(700).springify().damping(12)} className="space-y-2">
            ...
            <Animated.View entering={FadeInDown.delay(100).duration(700).springify().damping(12)} className="flex-row justify-around">
                <View className="flex rounded-full  p-2" style={{backgroundColor:'#A2CA71'}}>
                    ...
                    >
                        <ClockIcon size ={hp(5.5)} strokeWidth={2.5} color="#525252"/>
                    </View>
                ...
                <View className="flex rounded-full p-2" style={{backgroundColor:'#A2CA71'}}>
                    <View
                     ...
                     className="bg-white rounded-full flex items-center justify-center"
                    >
                        <UsersIcon size ={hp(5.5)} strokeWidth={2.5} color="#525252"/>
                    </View>
                    <View className="flex items-center py-2 space-y-1">
                        <Text style={{fontSize:hp(2)}} className="font-bold text neutral-700">
                            03
                ...
                <View className="flex rounded-full  p-2" style={{backgroundColor:'#A2CA71'}}>
                    <View
                     ...
                     className="bg-white rounded-full flex items-center justify-center"
                    >
                        <FireIcon size ={hp(5.5)} strokeWidth={2.5} color="#525252"/>
                    </View>
                    <View className="flex items-center py-2 space-y-1">
                        <Text style={{fontSize:hp(2)}} className="font-bold text neutral-700">
                            90
                ...
                <View className="flex rounded-full  p-2" style={{backgroundColor:'#A2CA71'}}>
                    <View
                     ...
                     className="bg-white rounded-full flex items-center justify-center"
                    >
                        <Square3Stack3DIcon size ={hp(5.5)} strokeWidth={2.5} color="#525252"/>
                    </View>
                    <View className="flex items-center py-2 space-y-1">
                        <Text style={{fontSize:hp(2)}} className="font-bold text neutral-700">
                                ...
                                <View key={i} className="flex-row space-x-4">
                                    <View style={{height:hp(1.5), width:hp(1.5), backgroundColor:'#A2CA71'}} className=" rounded-full"></View>
                                        <View className="flex-row space-x-2">
                                            ...
                                            <Text style={{fontSize:hp(1.7)}} className="font-extrabold text-neutral-500">{meal['strIngredient'+i]}</Text>
