    ...
    <View className="flex-1 justify-center items-center space-y-10 bg-amber-500" >
      ...
      <Animated.View className="bg-white/20 rounded-full " style={{padding:firstRing}}>
       <Animated.View className="bg-white/20 rounded-full " style={{padding:secondRing}}>
        <Image style={{height:hp(20),width:hp(20), borderRadius:100}} source={{uri:'https://logo.com/image-cdn/images/kts928pd/production/b374a124fc505ab3255fadae257d90e8e4a4855e-449x432.png?w=1080&q=72'}}></Image>
       </Animated.View>
      </Animated.View>
